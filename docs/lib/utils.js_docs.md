# Documentation: lib/utils.js

## File Metadata

- **Path**: `lib/utils.js`
- **Type**: .js
- **Size**: 27764 bytes (27.11 KB)
- **Lines**: 995
- **Last Modified**: 2025-11-15T20:36:35.101367
...
This JavaScript/TypeScript file (`utils.js`) It contains 43 function(s). The file exports: type, type, type, type, type, type, type, type, type, type.

## Detailed Analysis

### Structure

**Functions** (43): bottom, cloneLayout, modifyLayout, withLayoutItem, cloneLayoutItem, childrenEqual, in, fastPositionEqual, collides, compact, resolveCompactionCollision, compactItem, correctBounds, getLayoutItem, getFirstCollision, getAllCollisions, getStatics, moveElement, moveElementAwayFromCollision, perc ... and 23 more
...
Documentation: * Return the bottom coordinate of the layout.
 *
 * @param  {Array} layout Layout array.
 * @return {Number}       Bottom coordinate.
...
```javascript
import { type, type, type } from './lib/utils.js';
```
...
- **Maintainability**: Medium-sized file - monitor complexity

---
*Documentation generated on 2025-11-15T20:39:40.899914Z*
