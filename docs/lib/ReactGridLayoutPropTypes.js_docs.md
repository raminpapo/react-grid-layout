# Documentation: lib/ReactGridLayoutPropTypes.js

## File Metadata

- **Path**: `lib/ReactGridLayoutPropTypes.js`
- **Type**: .js
- **Size**: 7206 bytes (7.04 KB)
- **Lines**: 241
...
This JavaScript/TypeScript file (`ReactGridLayoutPropTypes.js`) The file exports: type, type, resizeHandleAxesType, resizeHandleType, type, type, default.
...
```javascript
import { type, type, resizeHandleAxesType } from './lib/ReactGridLayoutPropTypes.js';
```
...
---
*Documentation generated on 2025-11-15T20:39:40.881626Z*
