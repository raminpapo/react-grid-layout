# Documentation: test/examples/19-allow-overlap.jsx

## File Metadata

- **Path**: `test/examples/19-allow-overlap.jsx`
- **Type**: .jsx
- **Size**: 1463 bytes (1.43 KB)
- **Lines**: 68
...
This JavaScript/TypeScript file (`19-allow-overlap.jsx`) defines 1 class(es): AllowOverlap. The file exports: AllowOverlap.

## Detailed Analysis

### Structure

**Classes** (1): AllowOverlap
...
**`AllowOverlap`**: Class defined in this file.
...
```javascript
import { AllowOverlap } from './test/examples/19-allow-overlap.jsx';
...
---
*Documentation generated on 2025-11-15T20:39:40.844304Z*
