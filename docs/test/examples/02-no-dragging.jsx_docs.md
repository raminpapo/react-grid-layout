# Documentation: test/examples/02-no-dragging.jsx

## File Metadata

- **Path**: `test/examples/02-no-dragging.jsx`
- **Type**: .jsx
- **Size**: 1457 bytes (1.42 KB)
- **Lines**: 68
...
This JavaScript/TypeScript file (`02-no-dragging.jsx`) defines 1 class(es): NoDraggingLayout. The file exports: NoDraggingLayout.

## Detailed Analysis

### Structure

**Classes** (1): NoDraggingLayout
...
**`NoDraggingLayout`**: Class defined in this file.
...
```javascript
import { NoDraggingLayout } from './test/examples/02-no-dragging.jsx';
...
---
*Documentation generated on 2025-11-15T20:39:40.799245Z*
