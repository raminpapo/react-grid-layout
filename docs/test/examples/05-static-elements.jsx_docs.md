# Documentation: test/examples/05-static-elements.jsx

## File Metadata

- **Path**: `test/examples/05-static-elements.jsx`
- **Type**: .jsx
- **Size**: 1670 bytes (1.63 KB)
- **Lines**: 63
...
This JavaScript/TypeScript file (`05-static-elements.jsx`) defines 1 class(es): StaticElementsLayout. The file exports: StaticElementsLayout.

## Detailed Analysis

### Structure

**Classes** (1): StaticElementsLayout
...
**`StaticElementsLayout`**: Class defined in this file.
...
```javascript
import { StaticElementsLayout } from './test/examples/05-static-elements.jsx';
...
---
*Documentation generated on 2025-11-15T20:39:40.797595Z*
