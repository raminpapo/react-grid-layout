# Documentation: test/examples/15-drag-from-outside.jsx

## File Metadata

- **Path**: `test/examples/15-drag-from-outside.jsx`
- **Type**: .jsx
- **Size**: 3965 bytes (3.87 KB)
- **Lines**: 140
...
This JavaScript/TypeScript file (`15-drag-from-outside.jsx`) defines 1 class(es): DragFromOutsideLayout. It contains 1 function(s). The file exports: DragFromOutsideLayout.

## Detailed Analysis

### Structure

**Classes** (1): DragFromOutsideLayout
...
**`DragFromOutsideLayout`**: Class defined in this file.
...
```javascript
import { DragFromOutsideLayout } from './test/examples/15-drag-from-outside.jsx';
...
---
*Documentation generated on 2025-11-15T20:39:40.814499Z*
