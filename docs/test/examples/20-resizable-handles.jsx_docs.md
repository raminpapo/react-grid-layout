# Documentation: test/examples/20-resizable-handles.jsx

## File Metadata

- **Path**: `test/examples/20-resizable-handles.jsx`
- **Type**: .jsx
- **Size**: 1528 bytes (1.49 KB)
- **Lines**: 69
...
This JavaScript/TypeScript file (`20-resizable-handles.jsx`) defines 1 class(es): ResizableHandles. The file exports: ResizableHandles.

## Detailed Analysis

### Structure

**Classes** (1): ResizableHandles
...
**`ResizableHandles`**: Class defined in this file.
...
```javascript
import { ResizableHandles } from './test/examples/20-resizable-handles.jsx';
...
---
*Documentation generated on 2025-11-15T20:39:40.819910Z*
