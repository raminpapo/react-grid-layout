# Documentation: flow-typed/npm/prop-types_v15.x.x.js

## File Metadata

- **Path**: `flow-typed/npm/prop-types_v15.x.x.js`
- **Type**: .js
- **Size**: 1562 bytes (1.53 KB)
- **Lines**: 38
...
This JavaScript/TypeScript file (`prop-types_v15.x.x.js`) It contains 1 function(s). 

## Detailed Analysis

### Structure

**Functions** (1): checkPropTypes
...
---
*Documentation generated on 2025-11-15T20:39:41.098593Z*
